...
const COURSES = [
  {
    ...
    tag: "Get in-depth Comprehension of Faith",
    title: "The Audacity of Faith",
    label: "Learn More",
    desc: "Dive into an Understanding of Faith to st. By the end, you'll be crafting beautiful web pages from scratch.",
  },
  // {
  ...
  return (
    <section className="px-8">
      <div className="container mx-auto mb-24 text-center">
        ...
        >
          Browse through some of the most common discussions in Christian Community.
        </Typography>
      </div>
